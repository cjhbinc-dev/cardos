...
function mapPlaidAccountToCard(acc, connectionId, existing) {
...
module.exports = { CORS, getPlaidClient, getSupabaseAdmin, getUserFromJWT, plaidErrorInfo, logPlaidOk, mapPlaidAccountToCard };
